...
:icons: font
:pdf-theme: Dokumentation_gesamt.yml
:imagesdir: images
:pdf-page-size: a4
...
:docdate: {docdate}
:title: Enterprise Resource Planing and Dispatch Service der Stiller und Partner Mediengruppe GmbH/Holding (SPMG)
...
= Enterprise Resource Planing and Dispatch Service der Stiller und Partner Mediengruppe GmbH/Holding (SPMG)
{author} +
...
include::chapters/1_Intro_architecture.adoc[]

include::chapters/2_Complience_HR_Finance.adoc[]

include::chapters/3_Operations_Production_ProjectManagement.adoc[]

include::chapters/4_Operatopns_FacilityManagement_SecurityOps.adoc[]

include::chapters/5_CS_CRM.adoc[]

include::chapters/6_Backend.adoc[]

include::chapters/7_Frontend.adoc[]

include::chapters/8_Mobile_Application.adoc[]